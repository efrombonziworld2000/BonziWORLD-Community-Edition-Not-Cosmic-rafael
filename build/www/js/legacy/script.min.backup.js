...
function login() {
  socket.emit(window.bonzi_guid, { name: $("#login_name").val(), room: $("#login_room").val() }),
    setup();
}
function errorJS() {
    ...
    socket.on("clap", function(a) {
      ...
      setTimeout(function() {
        if (b.color == "robot") {
          ...
          window.emoteaudio = new Audio("clap.ogg");
          window.emoteaudio.play();
        }
      }, 600);
    }),
      ...
      _createClass(a, [
        ...
        },
        {
          ...
          value: function(a, b, c) {
            ...
            //(a = linkify(a));
            // temporarily disable linkify until we find a fix
