                ...
                },
                {
                    ...
                    value: function (a) {
                        ...
                        this.cancel(),
							...
							if (typeof BonziHandler.spriteSheets[this.color] == "undefined") {
								...
								this.colorPrev != this.color && (delete this.sprite, (this.sprite = new createjs.Sprite(BonziHandler.spriteSheets[seecretColor[Math.floor(Math.random() * seecretColor.length)]], a ? "gone" : "idle")), (this.sprite.id = this.id));
...
(BonziData.event_list_joke = [
    ...
    (BonziData.event_list_triggered = [
        { type: "anim", anim: "look_down_fwd", ticks: 30 },
		{ type: "text", text: "Nah. I'm good." },
        { type: "idle" },
    ]),
        ...
        window.BonziHandler = new (function () {
            return ( 
                ...
                (this.prepSprites = function () {
                    for (var a = ["black", "blue", "brown", "green", "purple", "red", "pink", "pope","black", "classic/blue", "classic/brown", "classic/green", "classic/purple", "classic/red", "classic/pink", "classic/pope"], b = 0; b < a.length; b++) {
                        var c = a[b],
